...
public class CriarContaSteps {
	...
	public void escreverUmEMailValido() {
		page.setEmail("messy@gmail.com");
		Assert.assertEquals("messy@gmail.com", driver.findElement(By.id("email_create")).getAttribute("value"));
	}
	...
	public void preecherTodosOsCamposComSucesso() {
		...
		// Email
		Assert.assertEquals("messy@gmail.com", driver.findElement(By.id("email")).getAttribute("value"));
	...
	public void queOClienteDigitouOEMailCadastrado() {
		...
		driver.get("http://automationpractice.com/index.php?controller=authentication&back=my-account");
		page = new CriarContaPage(driver);
		page.setEmailLogin("messy@gmail.com");
		Assert.assertEquals("messy@gmail.com", driver.findElement(By.id("email")).getAttribute("value"));
	}
